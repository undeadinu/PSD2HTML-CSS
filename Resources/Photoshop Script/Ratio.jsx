...
ratios: Panel { alignChildren: 'left',\
	...
	ratioGp: Group {\
		orientation: 'row',\
		golden: RadioButton {text: '황금 비율', value:true},\
		yamato: RadioButton {text: '야마토 비율'}\
	}\
},\
other: Panel { orientation: 'column', alignChildren: 'left',\
	text: '기타',\
	rectPosGp: Group { orientation: 'row',\
		s:StaticText { text: '정방형 위치'},\
		posGp: Group { orientation: 'row',\
			l:RadioButton {text: '왼쪽', value:true},\
			r:RadioButton {text: '오른쪽'}\
		}\
	},\
...
var HV = init(); // 가로/세로 중 어느쪽을 확장할지 결정
